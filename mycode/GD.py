...
from tensorflow.keras.layers import Dense,Dropout,BatchNormalization,Input,GaussianDropout
...
def infer(training,neurons = 100,layers = 3,dropout_rate = 0.2,epochs = 5000):
    ...
    for i in range(layers):
        ...
        hl = GaussianDropout(rate = dropout_rate)(hl, training=True)
